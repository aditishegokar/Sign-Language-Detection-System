# -*- coding: utf-8 -*-
"""
Created on Sun Jun  8 00:08:54 2025
...
l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="#ECFFE6", fg="black")
l1.place(x=190, y=50)

# that is for label1 registration

l2 = tk.Label(window, text="Full Name :", width=12, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
...
l3 = tk.Label(window, text="Address :", width=12, font=("Times new roman", 15, "bold"),background="#ECFFE6")
...
l5 = tk.Label(window, text="E-mail :", width=12, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
l5.place(x=130, y=250)
t4 = tk.Entry(window, textvar=Email, width=20, font=('', 15))
t4.place(x=330, y=250)
# that is for email address

l6 = tk.Label(window, text="Phone number :", width=12, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
...
l7 = tk.Label(window, text="Gender :", width=12, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
...
l8 = tk.Label(window, text="Age :", width=12, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
l8.place(x=130, y=400)
t6 = tk.Entry(window, textvar=age, width=20, font=('', 15))
t6.place(x=330, y=400)

l4 = tk.Label(window, text="User Name :", width=12, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
l4.place(x=130, y=450)
t3 = tk.Entry(window, textvar=username, width=20, font=('', 15))
t3.place(x=330, y=450)


l9 = tk.Label(window, text="Password :", width=12, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
l9.place(x=130, y=500)
t9 = tk.Entry(window, textvar=password, width=20, font=('', 15), show="*")
t9.place(x=330, y=500)

l10 = tk.Label(window, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"), bg="#ECFFE6")
